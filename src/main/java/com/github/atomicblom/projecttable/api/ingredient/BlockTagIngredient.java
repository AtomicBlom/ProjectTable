...
//    }
    ...
    public BlockTagIngredient(TagKey<Block> tag, int amount) {
        this.tagName = tag;
        this.amount = amount;
    }
    ...
    public ImmutableList<ItemStack> getItemStacks() {
        final ITag<Block> itemITag = ForgeRegistries.BLOCKS.tags().getTag(tagName);
    ...
    public TagKey<Block> getTagName() {
        return tagName;
    }
}
